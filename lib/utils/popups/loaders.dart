...
class BLoaders {
        ...
        content: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: BHelperFunctions.isDarkMode(Get.context!)
                ? BabyHubColors.darkerGrey.withOpacity(0.9)
  ...
  static successSnackBar({required title, message = "", duration = 3}) {
    Get.snackbar(
      ...
      icon: const Icon(Iconsax.check, color: BabyHubColors.white),
    );
  }
  ...
  static warningSnackBar({
    ...
    Get.snackbar(
      ...
      icon: const Icon(Iconsax.warning_2, color: BabyHubColors.white),
    );
  }
